...
// 3. resolution = T_ec // Ec:n pintadata, jossa mukana l�mp�tila (my�s par4_prod240 variantit
// k�yv�t)
// 4. resolution = T_ec_850 // Ec:n painepintadata (leveleiss� my�s lev88 = hybrid, z1000 = height,
